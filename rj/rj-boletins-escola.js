...
for (i = 0; i < jsonItens.length; i++) {
  ...
  var pdfname =
    pastaCartazes +
    "/" +
    jsonItem.CD_ESCOLA + "_" + jsonItem.ESCOLA + "_" + jsonItem.ETAPA_MINI +
    ".pdf";
...
function redimensiona() {
  var pontos_graficos = [
    ["barra", "VL_N01_LP_ESC_1B", "bh_lp_n1_1b", 142, 100],
    ["barra", "VL_N02_LP_ESC_1B", "bh_lp_n2_1b", 142, 100],
    ["barra", "VL_N03_LP_ESC_1B", "bh_lp_n3_1b", 142, 100],
    /* ["barra", "VL_N04_LP_ESC_1B", "bh_lp_n4_1b", 142, 100],
     */
    ["barra", "VL_N01_MT_ESC_1B", "bh_mt_n1_1b", 142, 100],
    ["barra", "VL_N02_MT_ESC_1B", "bh_mt_n2_1b", 142, 100],
    ["barra", "VL_N03_MT_ESC_1B", "bh_mt_n3_1b", 142, 100],
    /* ["barra", "VL_N04_MT_ESC_1B", "bh_mt_n4_1b", 142, 100], */

    ["barra", "VL_N01_ESCRITA_ESC_1B", "bh_escrita_n1_1b", 142, 100],
    ["barra", "VL_N02_ESCRITA_ESC_1B", "bh_escrita_n2_1b", 142, 100],
    ["barra", "VL_N03_ESCRITA_ESC_1B", "bh_escrita_n3_1b", 142, 100],
    /* ["barra", "VL_N04_ESCRITA_ESC_1B", "bh_escrita_n4_1b", 142, 100], */

    ["barra", "VL_N01_LP_ESC_2B", "bh_lp_n1_2b", 142, 100],
    ["barra", "VL_N02_LP_ESC_2B", "bh_lp_n2_2b", 142, 100],
    ["barra", "VL_N03_LP_ESC_2B", "bh_lp_n3_2b", 142, 100],
    /* ["barra", "VL_N04_LP_ESC_2B", "bh_lp_n4_2b", 142, 100], */

    ["barra", "VL_N01_MT_ESC_2B", "bh_mt_n1_2b", 142, 100],
    ["barra", "VL_N02_MT_ESC_2B", "bh_mt_n2_2b", 142, 100],
    ["barra", "VL_N03_MT_ESC_2B", "bh_mt_n3_2b", 142, 100],
    /* ["barra", "VL_N04_MT_ESC_2B", "bh_mt_n4_2b", 142, 100], */

    ["barra", "VL_N01_LP_ESC_3B", "bh_lp_n1_3b", 142, 100],
    ["barra", "VL_N02_LP_ESC_3B", "bh_lp_n2_3b", 142, 100],
    ["barra", "VL_N03_LP_ESC_3B", "bh_lp_n3_3b", 142, 100],
    /* ["barra", "VL_N04_LP_ESC_3B", "bh_lp_n4_3b", 142, 100], */

    ["barra", "VL_N01_MT_ESC_3B", "bh_mt_n1_3b", 142, 100],
    ["barra", "VL_N02_MT_ESC_3B", "bh_mt_n2_3b", 142, 100],
    ["barra", "VL_N03_MT_ESC_3B", "bh_mt_n3_3b", 142, 100],
    /* ["barra", "VL_N04_MT_ESC_3B", "bh_mt_n4_3b", 142, 100], */

    ["barra", "VL_N01_ESCRITA_ESC_3B", "bh_escrita_n1_3b", 142, 100],
    ["barra", "VL_N02_ESCRITA_ESC_3B", "bh_escrita_n2_3b", 142, 100],
    ["barra", "VL_N03_ESCRITA_ESC_3B", "bh_escrita_n3_3b", 142, 100],
    /* ["barra", "VL_N04_ESCRITA_ESC_3B", "bh_escrita_n4_3b", 142, 100], */

    ["barra", "VL_N01_LP_ESC_4B", "bh_lp_n1_4b", 142, 100],
    ["barra", "VL_N02_LP_ESC_4B", "bh_lp_n2_4b", 142, 100],
    ["barra", "VL_N03_LP_ESC_4B", "bh_lp_n3_4b", 142, 100],
/*     ["barra", "VL_N04_LP_ESC_4B", "bh_lp_n4_4b", 142, 100], */

    ["barra", "VL_N01_MT_ESC_4B", "bh_mt_n1_4b", 142, 100],
    ["barra", "VL_N02_MT_ESC_4B", "bh_mt_n2_4b", 142, 100],
    ["barra", "VL_N03_MT_ESC_4B", "bh_mt_n3_4b", 142, 100],
   /*  ["barra", "VL_N04_MT_ESC_4B", "bh_mt_n4_4b", 142, 100], */
