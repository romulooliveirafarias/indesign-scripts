...
function main(selected_json, selected_folder) {
  ...
  for (i = 0; i < jsonItens.length; i++) {
        ...
        if (page_item.isValid) {
          if (
            ...
            if (
              ...
              page_item.contents =
                "Básico - " + jsonItem[jsonKey] + " estudante";
            } else {
              page_item.contents =
    ...
    if (
      master_etapa.contents == "ENSINO FUNDAMENTAL DE 9 ANOS - 7º ANO" ||
      master_etapa.contents == "ENSINO FUNDAMENTAL DE 9 ANOS - 8º ANO" ||
      master_etapa.contents == "ENSINO FUNDAMENTAL DE 9 ANOS - 9º ANO"
    ) {
  ...
  function redimensiona() {
    ...
    var pontos_1b = [
      ...
      ["barra", "VL_N01_ESCRITA_ESC_1B", "bh_escrita_n1_1b", 644, 100],
      ["barra", "VL_N02_ESCRITA_ESC_1B", "bh_escrita_n2_1b", 200, 100],
      ["barra", "VL_N03_ESCRITA_ESC_1B", "bh_escrita_n3_1b", 200, 100],
      /* ["barra", "VL_N04_ESCRITA_ESC_1B", "bh_escrita_n4_1b", 200, 100], */
    ];
