...
for (i = 0; i < jsonItens.length; i++) {
  ...
  for (m = 0; m < keys.length; m++) {
    ...
    if (jsonKey.match("ESCOLA") || jsonKey.match("REGIONAL") || jsonKey.match("ETAPA")) {
    ...
    if (page_item.isValid) {
      if (jsonKey.match("VL_PRT") || jsonKey.match("VL_ACERTO") || jsonKey.match("VL_N")) {
        if (
          jsonItem[jsonKey] == "0" &&
          jsonItem[jsonKey] == "" &&
          jsonItem[jsonKey] == "-"
        ...
        if (
          ...
          page_item.contents = "Básico - " + jsonItem[jsonKey] + " estudantes";
        }
        ...
        if (
          ...
          page_item.contents = "Adequado - " + jsonItem[jsonKey] + " estudante";
        } else {
          page_item.contents =
        ...
        if (
          ...
          page_item.contents = "Avançado - " + jsonItem[jsonKey] + " estudante";
        } else {
          page_item.contents =
  ...
  myTable[0].cells[1].width = 411;
  myTable[0].cells[2].width = 65;
  myTable[0].cells[3].width = 65;
  myTable[0].cells[4].width = 65;
  ...
  myTable[0].cells[4].appliedCellStyle = "matriz-cab-center";
  ...
  myTable[0].cells[4].clearCellStyleOverrides(true);
  ...
  var col_lp_esc = myTable[0].columns[2].cells;

  for (var j = 1; j < col_lp_esc.length; j++) {
    var cell = col_lp_esc[j];
    cell.appliedCellStyle = "matriz-acerto";
    cell.clearCellStyleOverrides(true);
  }

  var col_lp_reg = myTable[0].columns[3].cells;
  ...
  var col_lp_mun = myTable[0].columns[4].cells;
  ...
  myTable[1].cells[1].width = 411;
  myTable[1].cells[2].width = 65;
  myTable[1].cells[3].width = 65;
  myTable[1].cells[4].width = 65;
  ...
  myTable[1].cells[4].appliedCellStyle = "matriz-cab-center";
  ...
  myTable[1].cells[4].clearCellStyleOverrides(true);
  ...
  var col_mt_esc = myTable[1].columns[2].cells;

  for (var j = 1; j < col_mt_esc.length; j++) {
    var cell = col_mt_esc[j];
    cell.appliedCellStyle = "matriz-acerto";
    cell.clearCellStyleOverrides(true);
  }

  var col_mt_reg = myTable[1].columns[3].cells;
  ...
  var col_mt_mun = myTable[1].columns[4].cells;
  ...
  var pdfname =
    pastaCartazes +
    "/" +
    jsonItem.CD_ESCOLA + "_" + jsonItem.ESCOLA + "_" + jsonItem.ETAPA_MINI + "_ADR1_2024" +
    ".pdf";
...
function redimensiona() {
  var pontos_graficos = [
    ["barra", "VL_N01_LP_ESC_1B", "bh_lp_n1_1b", 644, 100],
    ["barra", "VL_N02_LP_ESC_1B", "bh_lp_n2_1b", 644, 100],
    ["barra", "VL_N03_LP_ESC_1B", "bh_lp_n3_1b", 644, 100],
    /* ["barra", "VL_N04_LP_ESC_1B", "bh_lp_n4_1b", 644, 100],
     */
    ["barra", "VL_N01_MT_ESC_1B", "bh_mt_n1_1b", 644, 100],
    ["barra", "VL_N02_MT_ESC_1B", "bh_mt_n2_1b", 644, 100],
    ["barra", "VL_N03_MT_ESC_1B", "bh_mt_n3_1b", 644, 100],
    /* ["barra", "VL_N04_MT_ESC_1B", "bh_mt_n4_1b", 644, 100], */

    ["barra", "VL_N01_ESCRITA_ESC_1B", "bh_escrita_n1_1b", 644, 100],
    ["barra", "VL_N02_ESCRITA_ESC_1B", "bh_escrita_n2_1b", 644, 100],
    ["barra", "VL_N03_ESCRITA_ESC_1B", "bh_escrita_n3_1b", 644, 100],
    /* ["barra", "VL_N04_ESCRITA_ESC_1B", "bh_escrita_n4_1b", 200, 100], */
    
    /* ["barra", "VL_N01_LP_ESC_2B", "bh_lp_n1_2b", 644, 100],
    ["barra", "VL_N02_LP_ESC_2B", "bh_lp_n2_2b", 644, 100],
    ["barra", "VL_N03_LP_ESC_2B", "bh_lp_n3_2b", 644, 100],
    ["barra", "VL_N04_LP_ESC_2B", "bh_lp_n4_2b", 644, 100], */
    
    /* ["barra", "VL_N01_MT_ESC_2B", "bh_mt_n1_2b", 644, 100],
    ["barra", "VL_N02_MT_ESC_2B", "bh_mt_n2_2b", 644, 100],
    ["barra", "VL_N03_MT_ESC_2B", "bh_mt_n3_2b", 644, 100],
    ["barra", "VL_N04_MT_ESC_2B", "bh_mt_n4_2b", 644, 100], */
   
    /* ["barra", "VL_N01_LP_ESC_3B", "bh_lp_n1_3b", 644, 100],
    ["barra", "VL_N02_LP_ESC_3B", "bh_lp_n2_3b", 644, 100],
    ["barra", "VL_N03_LP_ESC_3B", "bh_lp_n3_3b", 644, 100],
    ["barra", "VL_N04_LP_ESC_3B", "bh_lp_n4_3b", 644, 100], */
    
    /* ["barra", "VL_N01_MT_ESC_3B", "bh_mt_n1_3b", 644, 100],
    ["barra", "VL_N02_MT_ESC_3B", "bh_mt_n2_3b", 644, 100],
    ["barra", "VL_N03_MT_ESC_3B", "bh_mt_n3_3b", 644, 100],
    ["barra", "VL_N04_MT_ESC_3B", "bh_mt_n4_3b", 644, 100], */

    /*  ["barra", "VL_N01_ESCRITA_ESC_3B", "bh_escrita_n1_3b", 200, 100],
    ["barra", "VL_N02_ESCRITA_ESC_3B", "bh_escrita_n2_3b", 200, 100],
    ["barra", "VL_N03_ESCRITA_ESC_3B", "bh_escrita_n3_3b", 200, 100],
    ["barra", "VL_N04_ESCRITA_ESC_3B", "bh_escrita_n4_3b", 200, 100], */
    
    /* ["barra", "VL_N01_LP_ESC_4B", "bh_lp_n1_4b", 644, 100],
    ["barra", "VL_N02_LP_ESC_4B", "bh_lp_n2_4b", 644, 100],
    ["barra", "VL_N03_LP_ESC_4B", "bh_lp_n3_4b", 644, 100],
    ["barra", "VL_N04_LP_ESC_4B", "bh_lp_n4_4b", 644, 100], */
    
    /* ["barra", "VL_N01_MT_ESC_4B", "bh_mt_n1_4b", 644, 100],
    ["barra", "VL_N02_MT_ESC_4B", "bh_mt_n2_4b", 644, 100],
    ["barra", "VL_N03_MT_ESC_4B", "bh_mt_n3_4b", 644, 100],
    ["barra", "VL_N04_MT_ESC_4B", "bh_mt_n4_4b", 644, 100], */
    
    /// PROVA RIO CEBRASPE

    /* ["barra", "VL_N01_CEBRASPE_LP_ESC_2021", "bh_lp_n1_2021", 200, 100],
    ["barra", "VL_N02_CEBRASPE_LP_ESC_2021", "bh_lp_n2_2021", 200, 100],
    ["barra", "VL_N03_CEBRASPE_LP_ESC_2021", "bh_lp_n3_2021", 200, 100],
    ["barra", "VL_N04_CEBRASPE_LP_ESC_2021", "bh_lp_n4_2021", 200, 100],

    ["barra", "VL_N01_CEBRASPE_LP_ESC_2022", "bh_lp_n1_2022", 200, 100],
    ["barra", "VL_N02_CEBRASPE_LP_ESC_2022", "bh_lp_n2_2022", 200, 100],
    ["barra", "VL_N03_CEBRASPE_LP_ESC_2022", "bh_lp_n3_2022", 200, 100],
    ["barra", "VL_N04_CEBRASPE_LP_ESC_2022", "bh_lp_n4_2022", 200, 100],

    ["barra", "VL_N01_CEBRASPE_LP_ESC_2023", "bh_lp_n1_2023", 200, 100],
    ["barra", "VL_N02_CEBRASPE_LP_ESC_2023", "bh_lp_n2_2023", 200, 100],
    ["barra", "VL_N03_CEBRASPE_LP_ESC_2023", "bh_lp_n3_2023", 200, 100],
    ["barra", "VL_N04_CEBRASPE_LP_ESC_2023", "bh_lp_n4_2023", 200, 100],

    ["barra", "VL_N01_CEBRASPE_MT_ESC_2021", "bh_mt_n1_2021", 200, 100],
    ["barra", "VL_N02_CEBRASPE_MT_ESC_2021", "bh_mt_n2_2021", 200, 100],
    ["barra", "VL_N03_CEBRASPE_MT_ESC_2021", "bh_mt_n3_2021", 200, 100],
    ["barra", "VL_N04_CEBRASPE_MT_ESC_2021", "bh_mt_n4_2021", 200, 100],

    ["barra", "VL_N01_CEBRASPE_MT_ESC_2022", "bh_mt_n1_2022", 200, 100],
    ["barra", "VL_N02_CEBRASPE_MT_ESC_2022", "bh_mt_n2_2022", 200, 100],
    ["barra", "VL_N03_CEBRASPE_MT_ESC_2022", "bh_mt_n3_2022", 200, 100],
    ["barra", "VL_N04_CEBRASPE_MT_ESC_2022", "bh_mt_n4_2022", 200, 100],

    ["barra", "VL_N01_CEBRASPE_MT_ESC_2023", "bh_mt_n1_2023", 200, 100],
    ["barra", "VL_N02_CEBRASPE_MT_ESC_2023", "bh_mt_n2_2023", 200, 100],
    ["barra", "VL_N03_CEBRASPE_MT_ESC_2023", "bh_mt_n3_2023", 200, 100],
    ["barra", "VL_N04_CEBRASPE_MT_ESC_2023", "bh_mt_n4_2023", 200, 100],

    ["barra", "VL_N01_CEBRASPE_ESCRITA_ESC_2021", "bh_escrita_n1_2021", 200, 100],
    ["barra", "VL_N02_CEBRASPE_ESCRITA_ESC_2021", "bh_escrita_n2_2021", 200, 100],
    ["barra", "VL_N03_CEBRASPE_ESCRITA_ESC_2021", "bh_escrita_n3_2021", 200, 100],
    ["barra", "VL_N04_CEBRASPE_ESCRITA_ESC_2021", "bh_escrita_n4_2021", 200, 100],

    ["barra", "VL_N01_CEBRASPE_ESCRITA_ESC_2022", "bh_escrita_n1_2022", 200, 100],
    ["barra", "VL_N02_CEBRASPE_ESCRITA_ESC_2022", "bh_escrita_n2_2022", 200, 100],
    ["barra", "VL_N03_CEBRASPE_ESCRITA_ESC_2022", "bh_escrita_n3_2022", 200, 100],
    ["barra", "VL_N04_CEBRASPE_ESCRITA_ESC_2022", "bh_escrita_n4_2022", 200, 100],
    
    ["barra", "VL_N01_CEBRASPE_ESCRITA_ESC_2023", "bh_escrita_n1_2023", 200, 100],
    ["barra", "VL_N02_CEBRASPE_ESCRITA_ESC_2023", "bh_escrita_n2_2023", 200, 100],
    ["barra", "VL_N03_CEBRASPE_ESCRITA_ESC_2023", "bh_escrita_n3_2023", 200, 100],
    ["barra", "VL_N04_CEBRASPE_ESCRITA_ESC_2023", "bh_escrita_n4_2023", 200, 100], */
  ];
  ...
  for (var m = 0; m < pontos_graficos.length; m++) {
    ...
    if (tipo == "barra") {
      if (
        ...
        redimensionar_valor == "" || redimensionar_valor == null
      ) {
